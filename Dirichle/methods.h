...
//double* Conjugate_gradient2(double **X, double **B, double* N_and_e, int n1, int m1,int n2, int m2, double h1, double k1, double h2, double k2)
//{
//    int s = 0;
//    double es = 100;
//    double h2 = 1 / (h * h);
...
//    {
//        Rs[i] = new double[ma + 1]();
//        Zs[i] = new double[ma + 1]();
//        AZs[i] = new double[ma+ 1]();
//    }
...
//        es = 0;
//        //1)..............................
//        double sk1 = skn(Rs, Rs, n, m, na, ma);
...
//        double sk2 = skn(AZs, Zs, n ,m, na, ma);
//        //Coeff!!!!!!
//        double a = sk1 / sk2;
...
double* Zeidel2(double **X, double **B, double* N_and_e, int n1, int m1,int n2, int m2, double h1, double k1, double h2, double k2)
{
    int s = 0;
    double es = 100;
    double h12 = 1 / (h1 * h1);
